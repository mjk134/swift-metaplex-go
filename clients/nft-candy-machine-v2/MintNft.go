...
// --
func (inst *MintNft) SetWhitelistTokenAccount(whitelistToken ag_solanago.PublicKey) *MintNft {
	inst.AccountMetaSlice[16] = ag_solanago.Meta(whitelistToken).WRITE()
	return inst
}

func (inst *MintNft) GetWhitelistTokenAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(16)
}

// --
func (inst *MintNft) SetWhitelistMintAccount(whitelistMint ag_solanago.PublicKey) *MintNft {
	inst.AccountMetaSlice[17] = ag_solanago.Meta(whitelistMint).WRITE()
	return inst
}

func (inst *MintNft) GetWhitelistMintAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(17)
}

// --
func (inst *MintNft) SetWhitelistBurnAuthorityAccount(whitelistBurnAuthority ag_solanago.PublicKey) *MintNft {
	inst.AccountMetaSlice[18] = ag_solanago.Meta(whitelistBurnAuthority).SIGNER()
	return inst
}

func (inst *MintNft) GetWhitelistBurnAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(18)
}

// --
func (inst *MintNft) SetUserPayingAccount(userPayingAccountAddress ag_solanago.PublicKey) *MintNft {
	inst.AccountMetaSlice[19] = ag_solanago.Meta(userPayingAccountAddress).WRITE()
	return inst
}

func (inst *MintNft) GetUserPayingAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(19)
}

// --
func (inst *MintNft) SetTransferAuthorityAccount(transferAuthority ag_solanago.PublicKey) *MintNft {
	inst.AccountMetaSlice[20] = ag_solanago.Meta(transferAuthority).SIGNER()
	return inst
}

func (inst *MintNft) GetTransferAuthorityAccount() *ag_solanago.AccountMeta {
...
func NewMintNftInstruction(
	...
	whitelistToken interface{},
	whitelistMint interface{},
	whitelistBurnAuthority interface{},
	userPayingAccount interface{},
	transferAuthority interface{}) *MintNft {
		MintNft := NewMintNftInstructionBuilder().
		...
		if whitelistToken != nil && whitelistMint != nil && whitelistBurnAuthority != nil {
			MintNft.SetWhitelistTokenAccount(whitelistToken.(ag_solanago.PublicKey))
			MintNft.SetWhitelistMintAccount(whitelistMint.(ag_solanago.PublicKey))
			MintNft.SetWhitelistBurnAuthorityAccount(whitelistBurnAuthority.(ag_solanago.PublicKey))
		}

		if userPayingAccount != nil && transferAuthority != nil {
			MintNft.SetUserPayingAccount(userPayingAccount.(ag_solanago.PublicKey))
			MintNft.SetTransferAuthorityAccount(transferAuthority.(ag_solanago.PublicKey))
		}
